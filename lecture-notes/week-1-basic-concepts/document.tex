...
%Abstrak
\begin{abstract}
In this lecture, we introduce the fundamental concepts of statistics, its key elements and principles. We begin with an exploration of the process of collecting, presenting, and summarizing data as a foundation for statistical analysis. Afterwards, we shift our focus towards probabilities, specifically on how to assign and evaluate probabilities on events. We introduce Kolmogorov's axiomatic definition of probability, which provides the foundation of modern probability theory.
...
\begin{enumerate}
    \item Classify each variable as qualitative or quantitative.
    \begin{enumerate}
        \item Marital status of nurses in a hospital.
        \item Time it takes to run a marathon.
        \item Weights of lobsters in a tank in a restaurant.
        \item Colors of automobiles in a shopping center parking lot.
        \item Ounces of ice cream in a large milkshake.
        \item Capacity of the NFL football stadiums.
        \item Ages of people living in a personal care home.
    \end{enumerate}
    \item Classify each as nominal-level, ordinal-level, interval level, or ratio-level measurement.
    \begin{enumerate}
        \item Pages in the 25 best-selling mystery novels.
        \item Rankings of golfers in a tournament.
        \item Temperatures inside 10 pizza ovens.
        \item Weights of selected cell phones.
        \item Salaries of the coaches in the NFL.
        \item Times required to complete a chess game.
        \item Ratings of textbooks (poor, fair, good, excellent).
        \item Number of amps delivered by battery chargers.
        \item Ages of childeen in a day care center.
        \item Categories of magazines in a physician’s office (sports, women’s, health, men’s, news).
    \end{enumerate}
    \item In each of these statements, tell whether descriptive or inferential statistics have been used.
    \begin{enumerate}
        \item By 2040 at least 3.5 billion people will run short of water (World Future Society).
        \item Nine out of ten on-the-job fatalities are men (Source: USA TODAY Weekend).
        \item Expenditures for the cable industry were \$5.66 billion in 1996 (Source: USA TODAY).
        \item The median household income for people aged 25–34 is \$35,888 (Source: USA TODAY).
        \item Allergy therapy makes bees go away (Source: Prevention).
        \item Drinking decaffeinated coffee can raise cholesterol levels by 7\% (Source: American Heart Association).
        \item The national average annual medicine expenditure per person is \$1052 (Source: The Greensburg Tribune Review).
        \item Experts say that mortgage rates may soon hit bottom (Source: USA TODAY).
    \end{enumerate}
    \item Identify each study as being either observational or experimental.
    \begin{enumerate}
        \item Subjects were randomly assigned to two groups, and one group was given an herb and the other group a placebo. After 6 months, the numbers of respiratory tract infections each group had were compared.
        \item A researcher stood at a busy intersection to see if the color of the automobile that a person drives is related to running red lights.
        \item Subjects are randomly assigned to four groups. Each group is placed on one of four special diets—a low-fat diet, a high-fish diet, a combination of low-fat diet and high-fish diet, and a regular diet. After 6 months, the blood pressures of the groups are compared to see if diet has any effect on blood pressure.
    \end{enumerate}
    \item Classify each of the following variables as either discrete or continuous.
    \begin{enumerate}
        \item Number of pizzas sold by Pizza Express each day.
        \item Relative humidity levels in operating rooms at local hospitals.
        \item Number of bananas in a bunch at several local supermarkets.
        \item Lifetimes (in hours) of 15 iPod batteries.
        \item Weights of the backpacks of first graders on a school bus.
        \item Number of students each day who make appointments with a math tutor at a local college.
        \item Blood pressures of runners in a marathon.
    \end{enumerate}
\end{enumerate}
...
\subsection{Exercises}
\begin{enumerate}
    \item If two dice are rolled one time, find the probability of getting these results.
    \begin{enumerate}
        \item A sum of 9
        \item A sum of 7 or 11
        \item Doubles
        \item A sum less than 9
        \item A sum greater than or equal to 10
    \end{enumerate}
    \item A probability experiment is conducted. Which of these cannot be considered a probability outcome?
    \begin{enumerate}
        \item $\frac{2}{3}$
        \item $0.63$
        \item $-\frac{3}{5}$
        ...
        \item $125$\%
    \end{enumerate}
    \item In a statistics class there are 18 juniors and 10 seniors; 6 of the seniors are females, and 12 of the juniors are males. If a student is selected at random, find the probability of selecting the following.
    \begin{enumerate}
        \item A junior or a female
        \item A senior or a female
        \item A junior or a senior
    \end{enumerate}
    ...
    \end{enumerate}
    \item Two cards are randomly chosen without replacement from an ordinary deck of 52 cards. Let $B$ be the event that both cards are aces, let $A_s$ be the event that the ace of spades is chosen, and let $A$ be the event that at least one ace is chosen. Describe the following events in words, and find their corresponding probabilities
    \begin{enumerate}
        \item $P(B|A_s)$
        \item $P(B|A)$
    \end{enumerate}
    \item In a certain community, 36 percent of the families own a dog and 22 percent of the families that own a dog also own a cat. In addition, 30 percent of the families own a cat. What is
    \begin{enumerate}
        \item the probability that a randomly selected family owns both a dog and a cat?
        \item the conditional probability that a randomly selected family owns a dog given that it owns a cat?
    \end{enumerate}
    \item The color of a person's eyes is determined by a single pair of genes. If they are both blue-eyed genes, then the person will have blue eyes; if they are both brown-eyed genes, then the person will have brown eyes; and if one of them is a blue-eyed gene and the other a brown-eyed gene, then the person will have brown eyes. (Because of the latter fact, we say that the brown-eyed gene is dominant over the blue-eyed one.) A newborn child independently receives one eye gene from each of its parents, and the gene it receives from a parent is equally likely to be either of the two eye genes of that parent. Suppose that Smith and both of his parents have brown eyes, but Smith's sister has blue eyes.
    \begin{enumerate}
        \item What is the probability that Smith possesses a blue-eyed gene?
        \item Suppose that Smith's wife has blue eyes. What is the probability that their first child will have blue eyes?
        \item If their first child has brown eyes, what is the probability that their next child will also have brown eyes?
    \end{enumerate}
    \item $A$ and $B$ are involved in a duel. The rules of the duel are that they are to pick up their guns and shoot at each other simultaneously. If one or both are hit, then the duel is over. If both shots miss, then they repeat the process. Suppose that the results of the shots are independent and that each shot of $A$ will hit $B$ with probability $p_A$, and each shot of $B$ will hit $A$ with probability $p_B$. What is
    \begin{enumerate}
        \item the probability that $A$ is not hit?
        \item the probability that both duelists are hit?
        \item the probability that the duel ends after the $n$th round of shots?
        \item the conditional probability that the duel ends after the $n$th round of shots given that $A$ is not hit?
    \end{enumerate}
